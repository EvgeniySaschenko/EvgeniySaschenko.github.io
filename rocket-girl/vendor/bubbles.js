function textBubbles(textUser, letterColorsUser, canvasUser, canvasHeightUser, canvasWidthUser){
    ...
    function updateCanvasDimensions() {
        canvas.attr({
            height: canvasHeightUser,
            width: canvasWidthUser
        });
    ...
    drawName(textUser, letterColorsUser);
    bounceBubbles();
}